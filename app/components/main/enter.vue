...
<template>
  ...
  >
    ...
    >
      ...
      <div class="flex text-white font-semibold text-base flex-col gap-5 mt-6">
        <div class="p-5 point rounded-xs bg-blue-600 flex w-full gap-5 items-center">
          <IconVkbg class="text-xl" />
          <span> VK ID </span>
        </div>
        <div
          class="p-5  point rounded-xs bg-orange-500 flex w-full gap-5 items-center"
        >
          <IconGoogle class="text-xl" />
          <span> Google </span>
        </div>
        <div class="p-5 point rounded-xs bg-blue-200 flex w-full gap-5 items-center">
          <IconTg class="text-xl" />
          <span> Telegram </span>
        </div>
      </div>
    </div>
